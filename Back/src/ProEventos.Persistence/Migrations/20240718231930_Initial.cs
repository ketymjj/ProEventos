    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RededSociais", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RededSociais_Eventos_EventoId",
                        column: x => x.EventoId,
                        principalTable: "Eventos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RededSociais_Palestrantes_PalestranteId",
                        column: x => x.PalestranteId,
                        principalTable: "Palestrantes",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RededSociais_EventoId",
                table: "RededSociais",
                column: "EventoId");

            migrationBuilder.CreateIndex(
                name: "IX_RededSociais_PalestranteId",
                table: "RededSociais",
                column: "PalestranteId");
        }
